...
# Numeric representation of a letter (1-26)
...
# Numeric representation of a word
def str_to_int(word):
    word = word.lower()
    num = 0
...
def get_nodelist(jdata):
    ...
    for num,i in enumerate(jdata):
        ...
        n = str_to_int(n2)   # Get a number value for the surname
        a = i['awards']
        d = i['dblp_records']
...
class Rtree:
    ...
    def search(self, n1, n2, a, d1, d2):   # use: search("a","c",0,0,2)
        n1_ = str_to_int(n1.ljust(4, 'a')[:4])
        n2_ = str_to_int(n2.ljust(4, 'z')[:4])
